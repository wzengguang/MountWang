...
namespace Wang.Perks
{
    ...
    class DefaultPerksPatch
    {
        private static void Postfix(ref PerkObject ___OneHandedExtraHP, ref PerkObject ___OneHandedEdgePlacement,
            ...
            ref PerkObject ___TwoHandedPowerBasher, ref PerkObject ___TwoHandedSpeedBasher,
            ref int[] ____tierSkillRequirements)
        {
            ...
            ___TwoHandedPowerBasher.Initialize("{=xb8nogrn}Power Basher", "{=wr4bu29Y}Two handed weapons with less than 85 speed get %2 higher speed and %5 higher damage.", DefaultSkills.TwoHanded, ____tierSkillRequirements[2], ___TwoHandedSpeedBasher, SkillEffect.PerkRole.Personal, 10f, SkillEffect.PerkRole.None, 10f, SkillEffect.EffectIncrementType.AddFactor);
            ___TwoHandedSpeedBasher.Initialize("{=OPfL2Szs}Speed Basher", "{=45V8TzwK}Two handed Weapons with more than 100 speed get %1 higher speed and %2 higher damage.", DefaultSkills.TwoHanded, ____tierSkillRequirements[2], ___TwoHandedPowerBasher, SkillEffect.PerkRole.Personal, 5f, SkillEffect.PerkRole.None, 5f, SkillEffect.EffectIncrementType.AddFactor);
        }
    }
}
