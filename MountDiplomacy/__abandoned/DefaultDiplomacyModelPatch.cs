...
namespace Wang
{
    ...
    //        //0.5-2
    //        float relationFactor = (float)Math.Min(2.0, Math.Max(0.5, 1.0 + Math.Sqrt(Math.Abs(relationBetweenClans)) * (double)((relationBetweenClans < 0) ? (-0.06f) : 0.04f)));
    //        //1.15-0.85
    ...
    //        {
    //            num11 = 4000f * (float)(30.0 - Math.Sqrt(Math.Min(900.0, toDays)));
    //        }
    //        else
    //        {
    ...
    //        __result += (0f - num11) * (relationFactor * num2);
